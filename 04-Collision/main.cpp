...
void LoadResources()
{
	...
	sprites->Add(20001, 408, 225, 424, 241, texMisc); // brick
	sprites->Add(20002, 299, 188, 317, 206, texMisc); // super mushroom
	...
	ani = new CAnimation(100);      // super mushroom
	ani->Add(20002);
	...
	supermushroom->AddAnimation(602);

	supermushroom->SetPosition(99.0f, 56.0f);
